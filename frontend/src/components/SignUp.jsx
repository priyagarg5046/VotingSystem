...
const SignUp = () => {
  ...
  return (
    <div className="flex h-[100]% flex-col justify-center px-6 py-1 lg:px-8 bg-green-200 bg-opacity-25 overflow-hidden">
    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 className="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">New Voter Registration</h2>
    </div>
  
    <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-sm">
      <form className="space-y-3" action="#" method="POST"  onSubmit={signUpHandler}>
        <div>
        ...
        <div>
          <button type="submit" className="flex w-full justify-center rounded-md  bg-green-500 hover:bg-green-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign Up</button>
        </div>
      </form>
